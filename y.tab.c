...
static const yytype_uint8 yyrline[] =
{
      ...
      62,    62,    64,    64,    64,    64,    64,    67,    68,    70,
      78,    83,    85,   107,   124,   125,   126,   128,   132,   137,
     147,   155,   159
};
#endif
...
static const char *const yytname[] =
{
  ...
  "HEADER", "WHILE", "IF", "ELSE", "FOR", "'-'", "'+'", "'*'", "'/'",
  "'('", "')'", "'{'", "'}'", "';'", "'='", "$accept", "START",
  "HEADERFILE", "Main", "PROGRAM", "BLOCK", "CODE", "STATEMENT", "ERROR",
  "VARASSIGN", "ASSIGNMENT", "EXPR", "RELEXPR", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     265,   266,   267,    45,    43,    42,    47,    40,    41,   123,
     125,    59,    61
};
# endif
...
{
      -6,    16,    10,    30,   -32,   -32,    34,   -32,    13,    26,
      27,    22,    28,   -32,    25,    41,    31,    33,    22,    32,
     -32,   -32,     2,   -32,    35,   -32,   -32,    14,    29,    24,
      24,    37,   -32,   -32,   -32,   -32,   -32,    20,    14,    48,
      49,    40,    42,   -32,    14,    14,    14,    14,    20,    24,
      24,    36,    36,    23,    23,   -32,   -32,   -32,   -32,   -32,
     -32
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       9,     7,     0,    15,     0,    21,    16,     0,    19,     0,
       0,     0,     6,    10,    12,    28,    27,    22,     0,    32,
      31,     0,     0,     8,     0,     0,     0,     0,    20,     0,
       0,     0,     0,    24,    23,    25,    26,    30,    29,    13,
      14
};
...
{
      42,    -5,     1,    12,    31,    13,    14,    48,    33,    15,
       5,    16,    17,    53,    54,    55,    56,    35,    36,    57,
      58,    18,   -11,    12,     1,    13,    14,    39,    40,    15,
       9,    16,    17,    44,    45,    46,    47,     6,    46,    47,
       8,    18,    59,    60,    10,    28,    11,    27,    29,    26,
      30,    38,    32,    49,    50,    18,    34,    43,    51,     4,
      52
};

static const yytype_uint8 yycheck[] =
{
      30,     7,     8,     1,    18,     3,     4,    38,    22,     7,
       0,     9,    10,    44,    45,    46,    47,     3,     4,    49,
      50,    19,    20,     1,     8,     3,     4,     3,     4,     7,
      17,     9,    10,    13,    14,    15,    16,     7,    15,    16,
       6,    19,    51,    52,    18,     4,    19,    22,    17,    21,
      17,    22,    20,     5,     5,    19,    21,    20,    18,     1,
      18
};
...
{
       0,     8,    24,    25,    25,     0,     7,    26,     6,    17,
      18,    19,     1,     3,     4,     7,     9,    10,    19,    27,
      28,    29,    30,    31,    32,    33,    21,    22,     4,    17,
      17,    29,    20,    29,    21,     3,     4,    34,    22,     3,
       4,    35,    35,    20,    13,    14,    15,    16,    34,     5,
       5,    18,    18,    34,    34,    34,    34,    35,    35,    28,
      28
};
...
#line 70 "yacc.y" /* yacc.c:1646  */
    {
			...
			//print_symbols();
			//printf("$2 = %s\n",$2);
			index1 = getPosition((yyvsp[0].var));
			//printf("Index1 = %d\n",index1);
			strcpy(symbol_table[index1]->type,(yyvsp[-1].var));
		}
...
#line 78 "yacc.y" /* yacc.c:1646  */
    {
	 		index1 = getPosition((yyvsp[-2].var));
	 		strcpy(symbol_table[index1]->type,(yyvsp[-3].var));
	 		symbol_table[index1]->value = atoi((yyvsp[0].var));
	 	}
...
#line 85 "yacc.y" /* yacc.c:1646  */
    {						
			...
			int index1 = getPosition((yyvsp[-2].var));	
    ...
    { /*if(isdigit($1[0]) && isdigit($3[0])) {
			...
			if(index != -1) {
				...
				AddQuadruple("+",$1,$3,$$);		
		     		...
		     		sprintf((yyval.var), "%d",(atoi((yyvsp[-2].var)) + atoi((yyvsp[0].var))));	
			}
...
#line 128 "yacc.y" /* yacc.c:1646  */
    {
     			index1 = getPosition((yyvsp[0].var));
     			sprintf((yyval.var),"%d",(symbol_table[index1]->value));     			
     		}
...
#line 137 "yacc.y" /* yacc.c:1646  */
    {
				...
				sprintf((yyval.var),"%d",(getValue(symbol_table[index1]->value, atoi((yyvsp[0].var)), (yyvsp[-1].var))));
			   }
...
#line 147 "yacc.y" /* yacc.c:1646  */
    { 	/*if (isdigit($3[0])) {
					...
					sprintf((yyval.var),"%d",(getValue(atoi((yyvsp[-2].var)), atoi((yyvsp[0].var)), (yyvsp[-1].var))));
			     }
